...
{
    public partial class BD_MULTIContext : DbContext
    {
        public BD_MULTIContext()
        {
        }

        public BD_MULTIContext(DbContextOptions<BD_MULTIContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
               optionsBuilder.UseSqlServer("Server=localhost;Database=BD_MULTI;Trusted_Connection=True;");
            }
        }
